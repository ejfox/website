...
> <cite>Neal Stephenson, <strong>Snow Crash</strong>, Bantam Books, 1992</cite>
...
- Guys have you heard of this [vim](https://vim.rtorr.com/) thing? Turns out it’s pretty useful (I’d been using nano/textmate/atom this whole time). I still use atom in my day-to-day, but it’s nice to be able to log into a remote server or edit a huge JSON file in the terminal when I need to.
...
I now have a [keybase profile](https://keybase.io/ejfox) that lists a handful of verified identities and addresses that are provably me. I am also now hosting my public PGP key at <https://ejfox.com/keybase.txt> so that people who want to send me encrypted messages can do so. It’s also nice that, even as much as I trust keybase, the PGP key is [hosted on an HTTPS website that I exclusively control](https://jacob.hoffman-andrews.com/README/the-safe-way-to-put-a-pgp-key-in-your-twitter-bio/). 
