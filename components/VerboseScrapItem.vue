<template>
  <div class="scrap-item group cursor-default pointer border-1 border-gray-200 align-baseline"
    v-if="scrap.content || scrap.description" @click="navigateTo(scrap.href, { external: true })">
    ...
    <span v-if="scrap.type === 'mastodon' || scrap.type === 'github-star'"
...
const formatDate = (date) => {
  return format(new Date(date), 'yy-M-dd|h:mma')
}
</script>
