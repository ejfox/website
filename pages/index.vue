<template>
	<section class="pa3 pa4-ns db cf mb4">
		<section class="intro pt2 measure-narrow lh-copy tj">
			<p class="pv2">
				Hello, my name is <strong>EJ Fox</strong>. I'm a
				hacker and journalist available for contract
				work. My work focuses on data visualization,
				systems, and politics. You can send me an email
				at
			...
			<p class="lh-copy pv2 tj">
				...
				<nuxt-link to="/audio/">sounds</nuxt-link>, or
				read <nuxt-link to="/books/">books</nuxt-link>.
			</p>
		</section>
		<Footer />
		...
		<div id="hcard-EJ-Fox" class="vcard w-100 f6 tc dn">
			...
			<a class="email db" href="mailto:ejfox@ejfox.com"
				>ejfox@ejfox.com</a
			>
			<div class="adr">
