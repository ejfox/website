<template>
  <nav :class="navClasses">
    <div class="container mx-auto md:py-1 md:flex md:flex-col items-start">
      <!-- Updated class: items-start -->
      <NuxtLink
        class="text-gray-800 dark:text-white text-xl font-bold px-2 md:p-4 md:mb-2 block"
        to="/"
        >EJ Fox</NuxtLink
      >
...
<script setup>
const linkClasses =
  "inline-block md:block md:w-full px-2 md:px-4 py-2 text-lg md:text-xl'"
...
const navClasses = computed(() => {
  const classes = [
    'p-2 md:p-4 xl:py-2 top-0 md:static md:top-auto bg-opacity-90 transition-opacity',
  ]
